...
var fileDescriptor_afd7664cd19b584a = []byte{
	...
	,
}
...
func (c *remoteSignerClient) SignP2PMessage(ctx context.Context, in *SignP2PMessageRequest, opts ...grpc.CallOption) (*SignedP2PMessageResponse, error) {
	out := new(SignedP2PMessageResponse)
	err := c.cc.Invoke(ctx, "/strangelove.horcrux.RemoteSigner/SignP2PMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedRemoteSignerServer) SignP2PMessage(ctx context.Context, req *SignP2PMessageRequest) (*SignedP2PMessageResponse, error) {
...
func _RemoteSigner_SignP2PMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignP2PMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RemoteSignerServer).SignP2PMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/strangelove.horcrux.RemoteSigner/SignP2PMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RemoteSignerServer).SignP2PMessage(ctx, req.(*SignP2PMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RemoteSigner_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RemoteSigner_SignP2PMessage_Handler,
		},
	},
