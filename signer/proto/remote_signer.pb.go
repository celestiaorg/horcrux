...
var fileDescriptor_afd7664cd19b584a = []byte{
	...
	0x3b, 0xb5, 0x12, 0xac, 0x96, 0x27, 0x88, 0xad, 0x00, 0xac, 0xc0, 0x68, 0x29, 0x13, 0x17, 0x4f,
	...
	0xaa, 0x1a, 0x21, 0x65, 0x70, 0x83, 0xd3, 0xb9, 0x78, 0x40, 0xc2, 0x41, 0x89, 0xe5, 0x4e, 0x95,
	0x25, 0xa9, 0xc5, 0x42, 0x1a, 0x38, 0x75, 0xc2, 0x94, 0xc0, 0xec, 0xd0, 0xc6, 0xa9, 0x32, 0x35,
	0x05, 0xa1, 0x16, 0x66, 0x91, 0x53, 0xe0, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e,
	0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31,
	0x44, 0x99, 0xa7, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x23, 0x19, 0xa9,
	0x5b, 0x96, 0x9a, 0x57, 0x52, 0x5a, 0x94, 0x5a, 0x0c, 0x8f, 0xd0, 0x32, 0x63, 0x7d, 0x48, 0x8c,
	0xea, 0x83, 0x63, 0x34, 0x89, 0x0d, 0x4c, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xd0, 0x21,
	0x7a, 0x6f, 0x3c, 0x02, 0x00, 0x00,
}
...
func (c *remoteSignerClient) SignRawBytes(ctx context.Context, in *SignRawBytesRequest, opts ...grpc.CallOption) (*SignedRawBytesResponse, error) {
	out := new(SignedRawBytesResponse)
	err := c.cc.Invoke(ctx, "/strangelove.horcrux.RemoteSigner/SignRawBytes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedRemoteSignerServer) SignRawBytes(ctx context.Context, req *SignRawBytesRequest) (*SignedRawBytesResponse, error) {
...
func _RemoteSigner_SignRawBytes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignRawBytesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RemoteSignerServer).SignRawBytes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/strangelove.horcrux.RemoteSigner/SignRawBytes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RemoteSignerServer).SignRawBytes(ctx, req.(*SignRawBytesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RemoteSigner_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RemoteSigner_SignRawBytes_Handler,
		},
	},
